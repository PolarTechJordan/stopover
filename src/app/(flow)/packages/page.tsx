...
import { PackageSku, AddonSku } from '@/lib/types';
import { 
...
export default function PackagesPage() {
  ...
  const recommendedSku = getRecommendedPackageSku(searchParams.layoverHours);
  ...
  }, [selectedPackageSku, recommendedSku, selectPackage]);
