...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  'zh-CN': {
    'brand.name': '龙腾出行 Stopover',
    'brand.short': 'Stopover AI',
    'brand.subtitle': '龙腾出行 · 中转礼宾',
    'nav.concierge': 'AI 礼宾 Demo',
    'nav.booking': '预订中转套餐',
    'nav.pitch': '展示 PPT',
    'nav.status': '履约状态机 Demo',
    'footer.title': '龙腾出行 Stopover 中转游项目 Web 演示原型',
    'footer.body': '以休息室为信任锚 + 行李全托管 + 模块化城市服务，激活长中转等待商机',
    'footer.rights': '© 2026 PolarTech / Jordan. All rights reserved.',
    ...
    'home.welcome': '我是 Stopover 中转礼宾。你可以直接说航班、中转时长、行李和想做什么，也可以用推荐方案或角色模板开始演示。',
    'home.sourceConnected': 'Qwen 多轮对话已连接',
  ...
  'en-US': {
    ...
    'brand.short': 'Stopover AI',
    'brand.subtitle': 'DragonPass · Stopover Concierge',
    ...
    'flow.journey.step': 'Step 5/5',
    'home.welcome': 'I am your Stopover concierge. Tell me your flights, layover length, baggage and what you want to do, or start with one of the scenario templates.',
    'home.sourceConnected': 'Qwen conversation connected',
